...
These instructions provide Azure-specific guidance for solutions created using Terraform, including how to incorporate and use Azure Verified Modules.
...
- MUST avoid overly permissive RBAC roles or network rules
