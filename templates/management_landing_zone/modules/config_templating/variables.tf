...
variable "naming_outputs" {
  type        = map(string)
  default     = {}
  description = "Resource names generated by the naming module. Merged with custom_replacements.names (naming_outputs takes precedence)."
}
